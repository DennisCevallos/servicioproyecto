    ...
    public class ModeloesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var modelo = await _context.Modelo
                .SingleOrDefaultAsync(m => m.IdModelo == id);
            if (modelo == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("IdModelo,Descripcion,Estado")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdModelo,Descripcion,Estado")] Modelo modelo)
        {
