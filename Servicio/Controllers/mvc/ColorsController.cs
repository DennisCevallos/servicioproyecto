    ...
    public class ColorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var color = await _context.Color
                .SingleOrDefaultAsync(m => m.IdColor == id);
            if (color == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("IdColor,Descripcion,Estado")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdColor,Descripcion,Estado")] Color color)
        {
            if (id != color.IdColor)
            {
                return NotFound();
