...
namespace Servicio.Controllers.mvc
{
    public class GeneroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdGenero,Descripcion,Estado")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGenero,Descripcion,Estado")] Genero genero)
        {
