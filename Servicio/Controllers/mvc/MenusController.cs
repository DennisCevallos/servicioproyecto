    ...
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var menu = await _context.Menu
                .SingleOrDefaultAsync(m => m.IdMenu == id);
            if (menu == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("IdMenu,Titulo,Url,Estado,TipoMenu")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMenu,Titulo,Url,Estado,TipoMenu")] Menu menu)
        {
            if (id != menu.IdMenu)
            {
                return NotFound();
